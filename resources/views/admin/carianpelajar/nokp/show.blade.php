...
<div class="container-fluid">
    <h1 class="mt-4">Carian Pelajar - Nombor KP</h1>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{route('admin-carianPelajar-noKP:index')}}" class="btn btn-secondary">Kembali</a>
                        <a href="{{route('pelajar-peribadi:edit', $pelajar)}}" class="btn btn-success">Kemaskini</a>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <div class="sb-nav-link-icon">
                                                    ...
                                                    <a href="{{route('admin-carianPelajar-noKP-waris:create', $pelajar)}}"><i class="fa fa-plus-circle"></i></a>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <div class="sb-nav-link-icon">
                                                    Tindakan
                                                    <a href="{{route('admin-carianPelajar-noKP-pengajianPelajar:create', $pelajar)}}"><i class="fa fa-plus-circle"></i></a>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <div class="sb-nav-link-icon">
                                                    Tindakan
                                                    <a href="{{route('admin-carianPelajar-noKP-vaksinasiPelajar:create', $pelajar)}}"><i class="fa fa-plus-circle"></i></a>
...
// WARIS DATATABLE
    ...
    var table = $('.waris-datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url : '{{ route('admin-carianPelajar-noKP-waris:list', $pelajar) }}'
            },
...
// PENGAJIAN PELAJAR DATATABLE
    $(function()
    {
      var table = $('.pengajianPelajar-datatable').DataTable({
          ...
          serverSide: true,
          ajax: {
              url : '{{ route('admin-carianPelajar-noKP-pengajianpelajar:list', $pelajar) }}'
              },
          language: {url: "//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/Malay.json"},
          columns: [
              {data: 'DT_RowIndex', name: 'DT_RowIndex'},
...
//VAKSINASI PELAJAR DATATABLE
    $(function()
    {
      var table = $('.vaksinasi-datatable').DataTable({
          ...
          serverSide: true,
          ajax: {
            url : '{{ route('admin-carianPelajar-noKP-vaksinasipelajar:list', $pelajar) }}'
            },
          language: {url: "//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/Malay.json"},
          columns:
          [
