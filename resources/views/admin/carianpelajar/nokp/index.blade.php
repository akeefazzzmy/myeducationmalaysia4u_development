...
<div class="container-fluid">
    <h1 class="mt-4">Cari Pelajar - Nombor KP</h1>
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active"><div class="sb-nav-link-icon"><i class="fa fa-id-card"></i></div>Nombor KP</li>
    </ol>
    <div class="row">
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <div class="card-body">
                                <form action="{{route('admin-carianPelajar-noKP:show')}}" method="POST" enctype="multipart/form-data">@csrf
