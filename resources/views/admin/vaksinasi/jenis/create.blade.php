...
<div class="container-fluid">
    <h1 class="mt-4">Daftar Jenis Vaksin</h1>
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active"><div class="sb-nav-link-icon"><i class="fa fa-plus-circle"></i></div>Daftar Jenis Vaksin</li>
    </ol>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Daftar Jenis Vaksin') }}</div>
                    <div class="card-body">
                        <form action="{{route('admin-vaksinasi-jenis:store')}}" method="POST" enctype="multipart/form-data">@csrf
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="jenisVaksin" class="form-control">
                                    </div>
                                    <div class="col-2">
