...
<div class="container-fluid">
    <h1 class="mt-4">Kemaskini Bangsa</h1>
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active"><div class="sb-nav-link-icon"><i class="fa fa-edit"></i></div>Kemaskini Bangsa</li>
    </ol>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Bangsa Edit') }}</div>                
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" class="form-control" value="{{$bangsa->keterangan}}">
                            </div>
