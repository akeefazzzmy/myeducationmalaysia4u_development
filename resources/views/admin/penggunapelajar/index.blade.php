...
<div class="container-fluid">
    <h1 class="mt-4">Pengurusan Pengguna - Pelajar</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active"><div class="sb-nav-link-icon"><i class="fas fa-user-friends"></i></div>Pengurusan Pengguna</li>
        <li class="breadcrumb-item active"><div class="sb-nav-link-icon"><i class="fas fa-user"></i></div>Pelajar</li>
    </ol>
    <div class="row">
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('admin-penggunaPelajar-cariPelajarKp:show')}}" method="POST" enctype="multipart/form-data">@csrf
