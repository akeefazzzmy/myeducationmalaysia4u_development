...
<div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active"><div class="sb-nav-link-icon"><i class="fa fa-flag"></i></div><a href="{{route('kedutaan-negara:index')}}">Negara</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <a href="{{route('kedutaan-negara:index')}}" class="btn btn-secondary">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
