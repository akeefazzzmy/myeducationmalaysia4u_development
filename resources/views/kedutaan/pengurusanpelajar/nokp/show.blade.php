            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <div class="sb-nav-link-icon">
                                                    Tindakan
                                                    <a href="{{route('kedutaan-pengurusanpelajar-waris:create', $pelajar)}}"><i class="fa fa-plus-circle"></i></a>
                                                </div>
                                            </th>
                                        </tr>
                                    </thead>
                        ...
                        <div class="mb-4"><hr class="solid"></div>
                        <a href="{{route('kedutaan-pengurusanpelajar:index')}}" class="btn btn-secondary">Kembali</a>
...
<script>
    ...
    $(function()
        ...
        var table = $('.waris-datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url : '{{ route('kedutaan-pengurusanpelajar-noKP-waris:list', $pelajar) }}'
                },
    ...
    $(function()
    {
      var table = $('.pengajianPelajar-datatable').DataTable({
          ...
          serverSide: true,
          ajax: {
              url : '{{ route('kedutaan-carianPelajar-noKP-pengajianpelajar:list', $pelajar) }}'
              },
          language: {url: "//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/Malay.json"},
          columns: [
              {data: 'DT_RowIndex', name: 'DT_RowIndex'},
...
$(function()
    {
      var table = $('.vaksinasi-datatable').DataTable({
          ...
          serverSide: true,
          ajax: {
            url : '{{ route('kedutaan-carianPelajar-noKP-vaksinasipelajar:list', $pelajar) }}'
            },
          language: {url: "//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/Malay.json"},
          columns:
          [
