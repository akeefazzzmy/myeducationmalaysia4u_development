...
{{-- <a class="navbar-brand" style="color:#ffffff" href=""><b>{{ config('app.name') }}</b></a> --}}
<a class="navbar-brand" style="color:#ffffff" href="{{ route('bem-dashboard:dashboard') }}"><b>{{ config('app.name') }}</b></a>
