                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <form action="{{route('bem-negara:index')}}" method="GET">
                        ...
                        <div class="card-body">
                            <table class="table">
                                    ...
                                    <th>
                                        <div class="float-left">
                                            <div class="sb-nav-link-icon">
                                                Tindakan
                                                <a href="{{route('bem-negara:create')}}"><i class="fa fa-plus-circle"></i></a>
                                                <a href="{{route('bem-negara:index')}}"><i class="fa fa-undo"></i></a>
                                            </div>
                                        </div>
                                    </th>                                                    
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('bem-negara:show', $negara)}}" class="btn btn-primary">Papar</a>
                                        <a href="{{route('bem-negara:edit', $negara)}}" class="btn btn-success">Kemaskini</a>
                                        <a onclick="return confirm('Rekod yang dihapuskan tidak dapat dikembalikan. Anda pasti untuk menghapuskan rekod yang dipilih?')" href="{{route('bem-negara:destroy', $negara)}}" class="btn btn-danger">Hapus</a>
                                    </td>
                                </tr>
                                @endforeach
                            </table>
