...
class MyProfileController extends Controller
{
    ...
    public function myProfile()
    {
        ...
        return view('em.myprofile.myProfile', compact('user'));
    }
    ...
    public function updateProfile(Request $request)
    {
       ...
       // $user->Kod_Status = $request->Status;
        ...
        return redirect()->route('em-my-profile')->with(
                    [
    ...
    {
        return view('em.myprofile.myProfile-password');
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        return redirect()->route('em-dashboard:dashboard')->with(
            [
                'alert-type'=>'alert-success',
