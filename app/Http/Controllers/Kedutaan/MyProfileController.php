...
class MyProfileController extends Controller
{
    ...
    public function myProfile()
    {
        ...
        return view('kedutaan.myprofile.myProfile', compact('user'));
    }
    ...
    public function updateProfile(Request $request)
    {
       ...
       // $user->Kod_Status = $request->Status;
        ...
        return redirect()->route('kedutaan-my-profile')->with(
                    [
    ...
    {
        return view('kedutaan.myprofile.myProfile-password');
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        return redirect()->route('kedutaan-dashboard:dashboard')->with(
            [
                'alert-type'=>'alert-success',
